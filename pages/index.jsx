	...
	if (triangle && stepCont) {
		...
		window.addEventListener("scroll", () => {
			...
			triangle.style.strokeDashoffset =
				1.05 -
				(-(stepCont?.getBoundingClientRect().top - vh(30)) +
					document.documentElement.clientHeight) /
					(stepContHeight - vh(30));
		});
	}
}
	...
	return (
		<>
			...
			<div className={styles.hero}>
				...
				<Link className={styles.heroDown} href="#everyone" id="everyone">
					&#9660;
				</Link>
			</div>
			...
			<div className={styles.steps} id="stepCont">
				<div className={styles.svgBackground}>
					{/* Figure this out some time: <Image
						src={"public/scrollBackground.svg"}
						width={295}
						height={3602}
            alt=""
				...
				<div id="steps">
					<div className={styles.text + " " + styles.left}>
						...
						<div className="buttonCont">
							...
							{/* <Link href="#steps2" className="buttonNext">
								&darr;
							</Link> */}
						</div>
				...
				<div id="steps2">
					<div className={styles.text + " " + styles.right}>
						...
						<div className="buttonCont">
							...
							{/* <Link href="#steps3" className="buttonNext">
								&darr;
							</Link> */}
						</div>
					</div>
