		...
		<>
			...
			<div className="page">
				...
				<p>
					...
					&quot;License&quot;); you may not use the files except in compliance
				...
				<p>
					...
					&quot;data&quot;) within our online offer and the websites, functions
					and content associated with it, as well as external online presences,
					such as our social media profile (hereinafter referred to as
					collectively referred to as the &quot;Online Offering&quot;). With
					regard to the terms used, such as &quot;processing&quot; or
					&quot;person responsible&quot;, we refer to the definitions in Article
				...
				<p>
					...
					assignment to an identifier such as a name, an identification number,
					location data, an online identifier (e.g. cookie) or one or more
					special features, are an expression of the physical, physiological,
					genetic, mental, economic, cultural or social identity of that natural
					person.
				</p>

				<p>
					&quot;Processing&quot; is any process or series of processes carried
					out with or without the aid of automated processes in connection with
					personal data. The term is broad and encompasses practically every
					handling of data.
				</p>

				<p>
					&quot;Pseudonymization&quot; means the processing of personal data in
					such a way that the personal data can no longer be assigned to a
					specific data subject without the use of additional information,
					provided that this additional information is stored separately and is
					subject to technical and organizational measures that ensure that the
					personal data not assigned to an identified or identifiable natural
					person.
				</p>

				<p>
					&quot;Profiling&quot; any type of automated processing of personal
					data, consisting in using this personal data to evaluate certain
					personal aspects relating to a natural person, in particular aspects
					related to work performance, economic situation, health, personal
					Analyze or predict that natural person’s preferences, interests,
					reliability, behavior, whereabouts or relocation.
				</p>

				<p>
					The &quot;person responsible&quot; is the natural or legal person,
					authority, institution or other body that alone or jointly with others
				...
				<p>
					...
					so-called &quot;order processing contract&quot;, this is done on the
				...
				<p>
					...
					cookie is primarily used to store information about a user (or the
					device on which the cookie is stored) during or after their visit to
					an online offer. Temporary cookies, or &quot;session cookies&quot; or
					&quot;transient cookies&quot;, are cookies that are deleted after a
					user leaves an online offer and closes his browser. In such a cookie,
					for example, the content of a shopping cart in an online shop or a
					login status can be saved. &quot;Permanent&quot; or
					&quot;persistent&quot; refers to cookies that remain stored even after
					the browser is closed. For example, the login status can be saved if
					users visit it after several days. The interests of the users can also
					be stored in such a cookie, which are used for range measurement or
					marketing purposes. &quot;Third-party cookies&quot; are cookies that
					are offered by providers other than the person responsible for
				...
				<p>
					...
					asked to deactivate the corresponding option in their browser&apos;s
					system settings. Saved cookies can be deleted in the system settings
					of the browser. The exclusion of cookies can lead to functional
				...
				<p>
					...
					user&apos;s operating system, referrer URL (the previously visited
				...
				<p>
					...
					on the users&apos; computers, in which the usage behavior and the
					interests of the users are stored. Furthermore, data can also be
					stored in the usage profiles independently of the devices used by the
					users (especially if the users are members of the respective platforms
				...
				<p>
					...
					videos or fonts (hereinafter uniformly referred to as
					&quot;content?&quot;).
				</p>
				...
				<p>
					...
					pixel tags (invisible graphics, also known as &quot;web beacons&quot;)
					for statistical or marketing purposes. The &quot;pixel tags&quot; can
					be used to evaluate information such as visitor traffic on the pages
					of this website.
				</p>

				<h4>Youtube</h4>
				<p>
					We embed videos from the &quot;YouTube&quot; platform provided by
				...
				<h4>Google Fonts</h4>
				<p>
					We integrate the fonts (&quot;Google Fonts&quot;) provided by Google
					LLC, 1600 Amphitheater Parkway, Mountain View, CA 94043, USA. Privacy
				...
				<p>
					...
					in online forms (&quot;ReCaptcha&quot;) from the provider Google LLC,
				...
				<h4>Google Maps</h4>
				<p>
					We integrate the maps of the &quot;Google Maps&quot; service provided
					by Google LLC, 1600 Amphitheater Parkway, Mountain View, CA 94043,
					USA. The data processed may include, in particular, IP addresses and
					location data of the users, but not without their consent (usually
					carried out as part of the settings on your mobile devices).The data
